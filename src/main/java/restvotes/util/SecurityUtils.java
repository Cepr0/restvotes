...
import static restvotes.domain.entity.User.Role;
...
public class SecurityUtils {
	 ...
	 * @param roles
	 */
	public static void runAs(String username, String password, Role... roles) {

		Assert.notNull(username, "Username must not be null!");
		Assert.notNull(password, "Password must not be null!");

		getContext().setAuthentication(new UsernamePasswordAuthenticationToken(username, password, asList(roles)));
	}
}
